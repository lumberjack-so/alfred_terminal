  ...
  return (
    <Presentation>
      <div className="flex h-full w-full flex-col">
        {/* Terminal Header */}
        <div className="sticky top-0 z-10 flex h-14 w-full items-center justify-between border-b border-gray-200 bg-white p-2 dark:border-gray-800 dark:bg-gray-800">
